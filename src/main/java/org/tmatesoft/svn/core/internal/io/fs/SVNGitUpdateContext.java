...
// From FSUpdateContext
public class SVNGitUpdateContext {
    ...
    public SVNGitUpdateContext(FSRepository repository, FSFS owner, long revision, File reportFile,
    ...
    private void updateEntry(long sourceRevision, String sourcePath, FSEntry sourceEntry,
        ...
        if (sourcePath != null && sourcePath.equals(targetPath)) {
            if (sourceEntry != null && targetEntry != null
                    && sourceEntry.getId().getNodeID().equals(targetEntry.getId().getNodeID())) {
                // nothing to update
                return;
            }
            related = true;
